...
%token<Ast.ordering -> int option -> Memory.offset -> Ast.instr'> ATOMIC_LOAD ATOMIC_STORE ATOMIC_RMW ATOMIC_RMW_CMPXCHG
%token ATOMIC_FENCE
...
plain_instr :
  ...
  | ATOMIC_LOAD ordering_opt offset_opt align_opt { fun c -> $1 $2 $4 $3 }
  | ATOMIC_STORE ordering_opt offset_opt align_opt { fun c -> $1 $2 $4 $3 }
  | ATOMIC_RMW ordering_opt offset_opt align_opt { fun c -> $1 $2 $4 $3 }
  | ATOMIC_RMW_CMPXCHG ordering_opt offset_opt align_opt { fun c -> $1 $2 $4 $3 }
